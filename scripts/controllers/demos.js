							...
							fnSuccess: function(data) {
								...
								Api.getValues({
									...
									fnSuccess: function(data) {
										...
										var total = _.reduce(votes, function(memo, num) {
											return memo + num;
										}, 0);
										var avg = total / votes.length;

										//DISPLAY TOTAL VOTES RESULT
										$('.instructions', el).html(votes.length 
											+ ' votes collected with an average of:');
			...
			this.view({
				...
				fnLoad: function(el) {
					...
					$('.charts1', el).kendoChart({
						...
						seriesColors: ['#cd1533', '#d43851', '#dc5c71', '#e47f8f', '#eba1ad', '#009bd7', '#26aadd', '#4db9e3', '#73c8e9', '#99d7ef'],
						valueAxis: {
							labels: {
